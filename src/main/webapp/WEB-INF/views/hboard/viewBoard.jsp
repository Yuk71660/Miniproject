   ...
   <div class="container">
      ...
      <div class="board">
         ...
         <div class="mb-3 mt-3">
            ...
            <div id="content" style="border: 1px solid #dee2e6; border-radius:0.375rem; padding : 0.375rem 0.75rem;">
                        ...
                        <tr>
                           <c:choose>
                              <c:when test="${file.base64Image != null }">
                                 <!-- 이미지 -->
                                 <td><img src="data:${file.fileType };base64,${file.base64Image}" /></td>
                              </c:when>
                              <c:otherwise>
                                 <!-- 이미지가 아닌 -->
                                 <td><a href='/resources/boardUpFiles/${file.newFileName }'><img src="/resources/images/noimage.png" /></a></td>
                              </c:otherwise>
                           </c:choose>
