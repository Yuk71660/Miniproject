...
public class HBoardServiceImpl implements HBoardService {
	...
	private PageResponseDTO<HBoard> pagingProcess(PageRequestDTO pageRequestDTO) throws Exception {
		PageResponseDTO<HBoard> pageResponseDTO = new PageResponseDTO<HBoard>(pageRequestDTO.getPageNo(),
...
//               System.out.println(file.toString());
			...
			savePoint(newBoard.getWriter(), "게시글작성");
	...
	@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.DEFAULT, rollbackFor = Exception.class)
	public void savePoint(String pointwho, String why) throws Exception {
